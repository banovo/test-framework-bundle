...
namespace TestFrameworkBundle\Behat\ServiceContainer;
...
use TestFrameworkBundle\Behat\Driver\OroSelenium2Factory;
        ...
        $builder
            ->children()
                ...
                ->scalarNode('reference_initializer_class')
                    ->defaultValue('TestFrameworkBundle\Behat\Fixtures\ReferenceRepositoryInitializer')
                ->end()
            ->end();
    }
