...
namespace TestFrameworkBundle\Behat\Listener;
...
class RunTimeSubscriber implements EventSubscriberInterface
{
    ...
    public function afterScenario(AfterScenarioTested $scope)
    {
        ...
        $screenshotContent = $this->mink->getSession()->getDriver()->getScreenshot();
        file_put_contents($screenshot, $screenshotContent);
        ...
        $htmlContent = $this->mink->getSession()->getDriver()->getContent();
